...
\newcommand{\githubRepoUrl}{https://github.com/stevemarple/FTDI_AIO}
...
\newcommand{\documentAttribution}{``FTDI all-in-one manual. Steve
  R. Marple. \gitCommitYear. \githubRepoUrl''}

\begin{document}

\title{FTDI all-in-one manual\\ \vspace*{1ex}
  \smaller \href{\githubRepoUrl}{\githubRepoUrl}}
...
% % \thispagestyle{empty}
\section*{Licence}
\href{\githubRepoUrl}{FTDI all-in-one} manual by Steve R. Marple is
licensed under a \href{\ccBySaFourUrl}{Creative Commons Attribution
